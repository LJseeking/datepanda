...
// Import from the dedicated script client generated in node_modules/@prisma/script-client
// This avoids conflicts with the main App client and ensures scripts run independently
// @ts-ignore - this module is generated at build time
var script_client_1 = require("@prisma/script-client");
...
var prisma = new script_client_1.PrismaClient({
    log: ["query"],
});
